...
###
#	t, L, GW, GS, datetime_offset, datalabels = get_data_regions()
#	
#	
def get_data_regions(schema='agg_avg_1hour_pdata_caps_eu2020', detrend=True, metadata=None, inspector=None, localhost=True):
	...
	if detrend == True:
		...
		load = get_data('regions_load_org',schema,metadata)
